...
export const Header = ({ basket, products,data, setProducts }) => {
...
if(!readLS('data')){
  ...
  useEffect(() => {
    searchText.length > 0 ?
      setProducts(products.filter((item) => (item.name.toLowerCase().includes(searchText.toLowerCase()))))
      :
      setProducts(data)
  }, [searchText])
    ...
    <div className='header'>
      <div className="header__container">
        <div className="header__link">
            ...
            <div className='header__box'>
              <img src={require("../images/mail.png").default} alt="geo" className="header__mail" />
              <div>
            ...
            <ul className='header__list'>
              ...
              <li className='header__item'><a >Возврат</a></li>
        ...
        <div className="header__contact">
          {/* <div className="header__content"> */}
            ...
            <div className='header__search'>
              <input type="search" className='header__input' placeholder="Поиск..." onChange={(event) => setSearchText(event.target.value)} />
         ...
         {/*  </div>
          <div className="header__content"> */}
            <div className='header__tel'>
              ...
              <img src={require('../images/call.png').default} alt="caller" className='header__caller' />
            </div>
            <a className='header__price'>Прайс-лист<img src={require('../images/download.png').default} alt="download" /></a>
            <NavLink to='basket' className='header__basket'>
              <img src={require('../images/basket.png').default} alt="basket" className='basket__img' />
